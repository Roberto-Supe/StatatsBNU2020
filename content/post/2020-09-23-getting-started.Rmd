...
First, we need to install two programs, [R](www.cran.rstudio.com) and [R studio](https://rstudio.com/products/rstudio/download/#download). You may be wondering the differences between R and R studio, we will no go in detail in this blog but, I will mention that R studio is the Graphics Interface Device that makes R much easier for us. Install the versions recommended for your machine. 
